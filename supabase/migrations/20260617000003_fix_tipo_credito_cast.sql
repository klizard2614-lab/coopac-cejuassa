-- ============================================================
-- HOTFIX: crear_credito_con_cronograma — cast ENUM tipo_credito
-- Migración: 20260617000003
-- Corrige:  error 42804 detectado en test automático L1-T3 (Fase 4B-4D)
--           columna `tipo_credito` es ENUM, no TEXT — requiere cast explícito
-- ============================================================
--
-- Cambio respecto a 20260617000002:
--   ANTES: p_credito->>'tipo_credito'
--   AHORA:  NULLIF(p_credito->>'tipo_credito', '')::tipo_credito
--
--   NULLIF convierte string vacío '' a NULL antes del cast al ENUM,
--   lo que evita error si el frontend envía tipo_credito='' en lugar de null.
--
-- ============================================================
